                    ...
                    <ul class="nav">
                        ...
                        <li>
                            ...
                            <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${contextPath}/resources/img/user/05.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                            ...
                            <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${contextPath}/resources/img/user/06.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                            ...
                            <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${contextPath}/resources/img/user/07.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                            ...
                            <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${contextPath}/resources/img/user/08.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                        ...
                        <li>
                            ...
                            <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${contextPath}/resources/img/user/09.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
                            ...
                            <a href="#" class="media-box p mt0">
                              ...
                              <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${contextPath}/resources/img/user/10.jpg" alt="Image" class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                              <span class="media-box-body">
                                 <span class="media-box-heading">
